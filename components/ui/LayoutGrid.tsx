...
export const LayoutGrid = ({ cards }: { cards: Card[] }) => {
  ...
  return (
    ...
    <div className="gap-10 grid grid-cols-1 md:grid-cols-4 mx-auto p-10 w-full max-w-7xl h-full">
      {cards.map((card, i) => (
        <Button
          key={i}
  ...
  return (
    <div className="relative z-[60] flex flex-col justify-end bg-transparent shadow-2xl rounded-lg w-full h-full">
      <motion.div
        ...
        className="z-10 absolute inset-0 bg-black opacity-60 w-full h-full"
      />
      <motion.div
        initial={{
          opacity: 0,
